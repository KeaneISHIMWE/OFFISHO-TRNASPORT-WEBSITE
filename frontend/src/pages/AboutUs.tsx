      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <Link to="/about" className="text-sky-blue font-semibold text-sm uppercase tracking-wider hover:underline" style={{ color: '#3B82F6' }}>
              About Us
            </Link>
          </div>
          <motion.h1
            ...
            style={{ color: '#001F3F' }}
          >
            Your Trusted Partner for Event Transportation
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className="text-lg md:text-xl text-center max-w-3xl mx-auto px-4"
            style={{ color: '#4B5563' }}
          >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              >
                <p className="text-4xl font-bold mb-2" style={{ color: '#3B82F6' }}>
                  {stat.number}
                </p>
