...
const Cars: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 pt-20 md:pt-24">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-center mb-8 md:mb-12"
        >
          <span className="text-blue-500 font-semibold text-xs sm:text-sm uppercase tracking-wider">Our Fleet</span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-navy-blue mt-3 sm:mt-4 mb-3 sm:mb-4">
            Choose Your Perfect Ride
          </h1>
          <p className="text-gray-600 text-base sm:text-lg mt-3 sm:mt-4 mb-4 sm:mb-6 max-w-2xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
          ...
          <aside className="hidden lg:block lg:w-64 xl:w-72 bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 h-fit lg:sticky lg:top-24">
