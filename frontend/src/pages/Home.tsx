...
import { ArrowRight, CheckCircle2, Star, Shield, Clock, Car, MapPin, Phone, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-background/90" /> {/* Dark blue overlay */}
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            <motion.span
              ...
              className="inline-block px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary font-medium text-sm mb-6 backdrop-blur-sm"
            >
              Premium Event Car Rentals
            </motion.span>

            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
              Arrive in <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-sky-300">Style</span> at <br /> Every Event
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/booking"
                className="w-full sm:w-auto px-8 py-4 bg-primary hover:bg-primary/90 text-white rounded-xl font-semibold shadow-lg shadow-primary/25 transition-all hover:scale-105 flex items-center justify-center gap-2 group"
              >
                Book Your Ride
              ...
              <Link
                to="/cars"
                className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-xl font-semibold backdrop-blur-sm transition-all hover:scale-105"
              >
                View Our Fleet
              </Link>
            </div>
            ...
            {[
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="px-3 py-1 text-xs font-medium bg-primary text-white rounded-full mb-3 inline-block">
                    {car.tag}
                  </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Why Choose <span className="text-primary">Offisho?</span>
              </h2>
            ...
            >
              ...
              />
              {/* Floating Card */}
              <div className="absolute -bottom-6 -left-6 bg-card/90 backdrop-blur-md p-6 rounded-2xl border border-white/10 shadow-xl max-w-xs hidden md:block">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to Experience Luxury?</h2>
          <p className="text-slate-400 max-w-2xl mx-auto mb-10 text-lg">
            Book your dream car today and elevate your next event. Seamless booking, instant confirmation.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link to="/booking" className="px-8 py-4 bg-primary hover:bg-primary/90 text-white rounded-xl font-bold shadow-lg shadow-primary/25 transition-transform hover:scale-105">
              Book Now
            </Link>
            <Link to="/contact" className="px-8 py-4 bg-card border border-white/10 hover:border-primary/50 text-white rounded-xl font-bold transition-transform hover:scale-105">
              Contact Support
            </Link>
          </div>
        </div>
